...
For a full list of all changes, look at the [CHANGELOG](https://github.com/agardiman/loki/blob/release-2.8.x/CHANGELOG.md).
...
For a full list of all changes and fixes, look at the [CHANGELOG](https://github.com/agardiman/loki/blob/release-2.8.x/CHANGELOG.md).
