...
type Series struct {
	...
	Labels      []github_com_grafana_loki_v3_pkg_logproto.LabelAdapter `protobuf:"bytes,3,rep,name=labels,proto3,customtype=github.com/agardiman/loki/v3/pkg/logproto.LabelAdapter" json:"labels"`
